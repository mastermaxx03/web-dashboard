...
export default function AuthForget() {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/v1/auth/forgot-password`, {
        method: 'POST',
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/v1/auth/reset-password`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
